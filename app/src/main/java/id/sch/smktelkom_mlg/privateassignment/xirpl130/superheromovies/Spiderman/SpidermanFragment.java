...
public class SpidermanFragment extends Fragment {
    ...
    private static final String URL_DATA = "http://www.omdbapi.com/?s=spiderman&apikey=c20dda67";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<SpidermanListItem> listItems;


    public SpidermanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spiderman, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewSpi);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                SpidermanListItem item = new SpidermanListItem(
                            ...
                            adapter = new SpidermanAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
