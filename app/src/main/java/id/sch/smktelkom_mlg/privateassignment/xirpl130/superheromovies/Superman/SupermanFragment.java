...
public class SupermanFragment extends Fragment {
    ...
    private static final String URL_DATA = "http://www.omdbapi.com/?s=superman&apikey=c20dda67";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<SupermanListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewSup);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                SupermanListItem item = new SupermanListItem(
                            ...
                            adapter = new SupermanAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
