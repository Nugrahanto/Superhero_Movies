...
public class BatmanFragment extends Fragment {
    ...
    private static final String URL_DATA = "http://www.omdbapi.com/?s=Batman&apikey=c20dda67";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<BatmanListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewBat);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                BatmanListItem item = new BatmanListItem(
                            ...
                            adapter = new BatmanAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
