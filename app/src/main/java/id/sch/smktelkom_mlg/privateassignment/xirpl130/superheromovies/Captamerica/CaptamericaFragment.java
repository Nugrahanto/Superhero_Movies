 ...
 */
public class CaptamericaFragment extends Fragment {

    private static final String URL_DATA = "http://www.omdbapi.com/?s=captain+america&apikey=c20dda67";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<CaptamericaListItem> listItems;

    public CaptamericaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_captamerica, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewCap);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                CaptamericaListItem item = new CaptamericaListItem(
                            ...
                            adapter = new CaptamericaAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
