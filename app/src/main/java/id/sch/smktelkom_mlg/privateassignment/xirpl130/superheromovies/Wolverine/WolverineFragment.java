...
public class WolverineFragment extends Fragment {
    ...
    private static final String URL_DATA = "http://www.omdbapi.com/?s=wolverine&apikey=c20dda67";

    private RecyclerView recyclerView;
    private RecyclerView.Adapter adapter;

    private List<WolverineListItem> listItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wolverine, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewWol);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                WolverineListItem item = new WolverineListItem(
                            ...
                            adapter = new WolverineAdapter(listItems, getActivity().getApplicationContext()); //mengirim ke adapter
